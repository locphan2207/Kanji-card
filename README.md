...
which is the two scripts being one system seen twice, printed on the packaging.

The 印 stamped with the volume numeral is the only colour anywhere in the app.

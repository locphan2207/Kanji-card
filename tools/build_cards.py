#!/usr/bin/env python3
"""Build frontend/src/lib/data/cards.json from open kanji data plus the curated deck in tools/deck.json.
...
def main():
    ...
    out = os.path.join(ROOT, "frontend", "src", "lib", "data", "cards.json")
    # Consumed by frontend/src/routes/+page.js, which is the seam a backend replaces.
    with open(out, "w", encoding="utf-8") as fh:
        json.dump(cards, fh, ensure_ascii=False, separators=(",", ":"))
    print(f"{len(cards)} cards -> frontend/src/lib/data/cards.json")

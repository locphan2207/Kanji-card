#!/usr/bin/env python3
"""Build data/cards.js from open kanji data plus the curated deck in tools/deck.json.
...
def main():
    ...
    out = os.path.join(ROOT, "data", "cards.js")
    with open(out, "w", encoding="utf-8") as fh:
        ...
        fh.write("const CARDS = " + json.dumps(cards, ensure_ascii=False,
                                               separators=(",", ":")) + ";\n")
    print(f"{len(cards)} cards -> data/cards.js")
